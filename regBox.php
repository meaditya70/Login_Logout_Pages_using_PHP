...
<html class="no-js" lang="en"><!--<![endif]-->
    <head>
        ...
        <title>Register | Infinite Lens</title>
	...
	<body style="background-color:#070719">
		...
		<div class="head" align="center">
			...
			<div class="menu" id="myTopnav">
				...
				<a href="loginBox.php" id="login">Login</a>
			</div>
		</div>
		...
		<div class="section"  style="padding-top:80px;"  align="center">
			...
			<div class="form">
				...
				<h2 style='color:steelblue'>Register</h2>
				<?php
				...
				<form action="register.php" method="post">
					...
					<input type="image" name="submit" value="register" src="icons/go.png" />
					<div class="termsText" style="font-size:0.8em;">Already have an Account? <a href="loginBox.php" style="color:green">LOGIN NOW</a></div>
